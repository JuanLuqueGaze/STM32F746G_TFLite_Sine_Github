...
model_matrix_direction = 0x08049C4C;
...
subgraph.tensors = GetPointer(VT_SUBGRAPHS.VT_TENSORS, subgraph.direction, g_model, model_matrix_direction);
subgraph.inputs = GetPointer(VT_SUBGRAPHS.VT_INPUTS, subgraph.direction, g_model, model_matrix_direction);
subgraph.outputs = GetPointer(VT_SUBGRAPHS.VT_OUTPUTS, subgraph.direction, g_model, model_matrix_direction);
subgraph.operators = GetPointer(VT_SUBGRAPHS.VT_OPERATORS, subgraph.direction, g_model, model_matrix_direction);
subgraph.name = GetPointer(VT_SUBGRAPHS.VT_NAME, subgraph.direction, g_model, model_matrix_direction);
