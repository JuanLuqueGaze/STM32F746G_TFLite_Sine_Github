function field = GetField(VT_OFFSET, data_, g_model, model_matrix_direction)

  
    vtable = data_ - getnumber(g_model(data_ - model_matrix_direction+1),g_model(data_ - model_matrix_direction+2));
